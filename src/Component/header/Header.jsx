...
import { faBed, faCab, faCalendar, faCalendarDays, faHotel, faL, faPerson, faPlane, faTaxi } from "@fortawesome/free-solid-svg-icons";
...
const Header=({type}) => {
    ...
    return (
        <div className="header">
            ...
            more with a free Easy Stay account</p>
